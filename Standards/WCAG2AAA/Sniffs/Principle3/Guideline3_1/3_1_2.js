...
var HTMLCS_WCAG2AAA_Sniffs_Principle3_Guideline3_1_3_1_2 = {
    ...
    process: function(element, top)
    {
        ...
        HTMLCS.addMessage(HTMLCS.NOTICE, top, '言語の変更は lang 属性、または xml:lang 属性のいずれか、もしくは両方の指定によって行われているか確認してください。 Ensure that any change in language is marked using the lang and/or xml:lang attribute on an element, as appropriate.', 'H58');
            ...
            if ((!langEl.documentElement) && (langEl.nodeName.toLowerCase() !== 'html')) {
                if (langEl.hasAttribute('lang') === true) {
                    ...
                    if (sc3_1_1.isValidLanguageTag(lang) === false) {
                        HTMLCS.addMessage(HTMLCS.ERROR, langEl, 'この要素に指定された lang 属性の値は不正です。 The language specified in the lang attribute of this element does not appear to be well-formed.', 'H58.1.Lang');
                    }
                }
                ...
                if (langEl.hasAttribute('xml:lang') === true) {
                    ...
                    if (sc3_1_1.isValidLanguageTag(lang) === false) {
                        HTMLCS.addMessage(HTMLCS.ERROR, langEl, 'この要素に指定された xml:lang 属性の値は不正です。 The language specified in the xml:lang attribute of this element does not appear to be well-formed.', 'H58.1.XmlLang');
                    }
                }
            }//end if
        }//end for
